...
export default function FeaturedSection({ variant }: FeaturedProps) {
  ...
  if (variant === 'green') {
    const greenData = data as GreenData;
    return (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-4">
              {greenData.images.map((img, index) => (
                <div
                  key={index}
  ...
  const bridgeData = data as BridgeData;
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 reveal-on-scroll">
            ...
            <div className="space-y-6">
              {bridgeData.features.map((feature) => (
                <div
                  key={feature.title}
